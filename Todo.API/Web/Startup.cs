...
public static class Startup
{
            ...
            options.AddSecurityRequirement(new OpenApiSecurityRequirement
    {
        ...
        builder.Services.AddDbContext<ApplicationDbContext>(options =>
            options.UseNpgsql(builder.Configuration.GetConnectionString("PostgreSQL"), b => b.MigrationsAssembly("Web")));
        #endregion
        ...
        builder.Services.AddTransient<ITodoInterface, TodoRepository>();
        ...
        #region Validators
        builder.Services.AddScoped<IValidator<Todo>, Validator>();
        #endregion
    }
